...
obj_name_div = $('<div id="permdialog_objname" class="section"><b>File Path:</b><span id="permdialog_objname_namespan"></span> </div>')
...
perm_remove_user_button  = $('<button id="perm_remove_user" class="ui-button ui-widget ui-corner-all">Delete User/Group</button>')
...
perm_dialog.append($('<div id="permissions_user_title"><b>Select User/Group To Modify Permissions For:<b></div>'))
